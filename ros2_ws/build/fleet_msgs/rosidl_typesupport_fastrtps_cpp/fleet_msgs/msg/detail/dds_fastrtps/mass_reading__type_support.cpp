...
#include "fleet_msgs/msg/detail/mass_reading__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleet_msgs::msg::MassReading;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fleet_msgs::msg::MassReading *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fleet_msgs::msg::MassReading *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MassReading__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fleet_msgs::msg::MassReading *>(
...
static size_t _MassReading__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MassReading(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MassReading__callbacks = {
  "fleet_msgs::msg",
  "MassReading",
...
static rosidl_message_type_support_t _MassReading__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MassReading__callbacks,
...
{
  return &fleet_msgs::msg::typesupport_fastrtps_cpp::_MassReading__handle;
}
