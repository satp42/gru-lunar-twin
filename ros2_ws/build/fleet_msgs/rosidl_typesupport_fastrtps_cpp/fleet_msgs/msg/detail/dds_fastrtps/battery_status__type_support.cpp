...
#include "fleet_msgs/msg/detail/battery_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fleet_msgs::msg::BatteryStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: unit_id
  cdr << ros_message.unit_id;
  // Member: soc_percentage
  cdr << ros_message.soc_percentage;
  // Member: voltage_v
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fleet_msgs::msg::BatteryStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: soc_percentage
  {
    size_t item_size = sizeof(ros_message.soc_percentage);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleet_msgs::msg::BatteryStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fleet_msgs::msg::BatteryStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fleet_msgs::msg::BatteryStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<fleet_msgs::msg::BatteryStatus>()
{
  return &fleet_msgs::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fleet_msgs, msg, BatteryStatus)() {
  return &fleet_msgs::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
